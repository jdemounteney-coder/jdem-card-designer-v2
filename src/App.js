...
export default function SimpleCardDesigner() {
  ...
  const perPage = cardSize === 'bridge' ? 16 : 12;
  ...
  const Card = ({ c }) => (
    <div style={{position: 'relative', width: '100%', height: '100%', background: 'white', border: '1px solid #999', borderRadius: '3mm', overflow: 'hidden'}}>
      {cardStyle === 'picture' ? (
        <>
